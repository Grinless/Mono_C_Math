...
namespace C_Math.Polar
{
    ...
    public class PolarFunctions2D
    {
        ...
        public static float ArchimedeanSpiral(float theta, float amplitude, float n) =>
            amplitude * C_MathF.Pow(theta, 1 / n);
        ...
        {
            float sin = C_MathF.Sin(theta);
            sin *= sin;
            float numerator = 8 * (C_MathF.Cos(theta) * (sin * sin));
            float denumerator = 3 + C_MathF.Cos(4 * theta);
        ...
        {
            float sin = C_MathF.Sin(theta);
            return 4 * amplitude * (sin * sin) * C_MathF.Cos(theta);
        }
        ...
        public static float ButterflyCurve(float theta)
        {
            ...
            float logResult = C_MathF.Log(C_MathF.Sin(theta));
            float cos = 2 * C_MathF.Cos(4 * theta);
            float sin = C_MathF.Sin((float)(doubleAngle - C_MathF.PI) / 24);
        ...
        public static float CardioidCuspRight(float theta, float amplitude) =>
            2 * amplitude * (1 - C_MathF.Cos(theta));
        ...
        public static float CardioidCuspUp(float theta, float amplitude) =>
            2 * amplitude * (1 - C_MathF.Sin(theta));
        ...
        {
            float sin = C_MathF.Sin(theta);
            return 2 * amplitude * sin * C_MathF.Tan(theta);
        }
        ...
        public static float Cochleoid(float theta, float amplitide) =>
            (amplitide * C_MathF.Sin(theta)) / theta;
        ...
        public static float DevilsCurve(float theta, float amplitude, float b)
        {
            ...
            return C_MathF.Sqrt(numerator / denumerator);
        }
        ...
        public static PolarMultiOutput EightCurve(float theta, float amplitude)
        {
            ...
            float pos = C_MathF.Sqrt(aSqr * secantCubed * C_MathF.Cos(2 * theta));
        ...
        {
            float val = (a * a) * theta;
            return new PolarMultiOutput(C_MathF.Sqrt(val), -C_MathF.Sqrt(val));
        }
        ...
        {
            float tanTheta = C_MathF.Tan(theta);
        ...
        public static PolarMultiOutput HippopedeCurve(float a, float b, float theta)
        {
            ...
            return new PolarMultiOutput(C_MathF.Sqrt(rSquare), -C_MathF.Sqrt(rSquare));
        }
        ...
        public static float Hyperbola(float theta, float amplitude) =>
            (amplitude * (C_MathF.Log(2) - 1) / 1 - C_MathF.Log(1) * C_MathF.Cos(theta));
        ...
        public static PolarMultiOutput Lemniscate(float theta, float amplitude)
        {
            ...
            float inner = C_MathF.Sqrt(C_MathF.Sin(2 * theta));
        ...
        public static float MalteseCross(float theta) =>
            2 / C_MathF.Sqrt(C_MathF.Sin(4 * theta));
        ...
        {
            float innerProd = (b * C_MathF.Sin(theta) - (amplitude * C_MathF.Cos(theta)));
            return innerProd * C_MathF.Tan(theta);
        }
        ...
        public static float ScarabaeusCurve(float theta, float amplitude, float b) =>
            b * C_MathF.Cos(2 * theta) - amplitude * C_MathF.Cos(theta);
        ...
        {
            float secant = 1 / C_MathF.Cos(theta / 3);
        ...
        public static PolarMultiOutput WattsCurve(float angle, float a, float b, float c)
        {
            ...
            float b2 = b * b;
            float c2 = c * c;
            float cos2 = C_MathF.Cos(angle) * C_MathF.Cos(angle);
            float IP = a * C_MathF.Pow(C_MathF.Sin(angle) + C_MathF.Sqrt(c2 - a2 * cos2), 2);
            float IN = a * C_MathF.Pow(C_MathF.Sin(angle) - C_MathF.Sqrt(c2 - a2 * cos2), 2);
